...
ActiveStorage::PurgeJob.queue_adapter = :inline
  ...
  posts = Post.create!(
    ...
    {title: 'カルバリ', nation: 'オーストラリア', prefecture: 'パース', place: 'カルバリ国立公園', view_image: ActiveStorage::Blob.create_and_upload!(io: File.open("#{Rails.root}/db/fixtures/sample-post2.jpg"), filename:"sample-post2.jpg"), end_user_id: end_users[0].id },
